...
const StationInfo = (props) => {
  ...
  return (
    <div className="box">
	  ...
	  <p><strong>Network:</strong> {props.station.network}</p>
      <p><strong>Line:</strong> {props.station.lineName} Line</p>
      <p><strong>Address:</strong> <br />
        {props.station.name} Station<br />
		{props.station.address}<br/>
